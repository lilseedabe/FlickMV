...
const TimelineFixed: React.FC<TimelineProps> = ({
  ...
  const trackHeaderWidth = 180; // 固定幅に設定
                      ...
                      .map(clip => (
                        <motion.div
                          ...
                          style={{
                            ...
                            width: Math.max(timeToPixel(clip.duration), 40), // 最小幅を設定
