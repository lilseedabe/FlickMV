      ...
      <div className="flex items-center space-x-2">
        <motion.button
          ...
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('竢ｪ 10遘呈綾繧九・繧ｿ繝ｳ縺後け繝ｪ繝・け縺輔ｌ縺ｾ縺励◆');
            skipBackward();
          }}
        ...
        <motion.button
          ...
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('七 蜀咲函/荳譎ょ●豁｢繝懊ち繝ｳ縺後け繝ｪ繝・け縺輔ｌ縺ｾ縺励◆:', isPlaying ? '荳譎ょ●豁｢' : '蜀咲函');
            onPlayPause();
          }}
        ...
        <motion.button
          ...
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('竢ｹ・・蛛懈ｭ｢繝懊ち繝ｳ縺後け繝ｪ繝・け縺輔ｌ縺ｾ縺励◆');
            stop();
          }}
          className="p-2 hover:bg-dark-600 rounded-lg transition-colors control-btn"
          title="Stop"
        ...
        <motion.button
          ...
          onClick={(e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log('竢ｩ 10遘帝ｲ繧繝懊ち繝ｳ縺後け繝ｪ繝・け縺輔ｌ縺ｾ縺励◆');
            skipForward();
          }}
          className="p-2 hover:bg-dark-600 rounded-lg transition-colors control-btn"
